...
extern "C"
{
    ...
    wrPoseIK_CreateDefault(wrPoseIKHandle* handle,
    ...
    /// @see wrIKParams
    WRNCH_DLL_INTERFACE wrReturnCode
    wrPoseIK_CreateFromPose(wrPoseIKHandle* handle,
                            wrJointDefinitionHandleConst inputFormat,
    ...
    /// @brief Get IK solver parameters
    /// @see wrIKParams
    WRNCH_DLL_INTERFACE wrIKParamsHandleConst wrPoseIK_GetParams(wrPoseIKHandleConst handle);


    /// @brief Set IK solver parameters
    /// @param handle the handle to the IK solver you want to set params on.
    /// @param params Solver parameters
    /// @see wrIKParams
    WRNCH_DLL_INTERFACE void wrPoseIK_SetParams(wrPoseIKHandle handle,
                                                wrIKParamsHandleConst params);
    ...
    WRNCH_DLL_INTERFACE float wrPoseIK_GetIKProperty(wrPoseIKHandleConst handle,
