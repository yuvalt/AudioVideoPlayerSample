...
///         internal state. Instead, they are passed through ActivityModel instances.
/// @see ActivityModel
...
class IndividualActivityModelView
{
  public:
    ...
    char const* ClassName(int classIdx) const;
...
inline char const* IndividualActivityModelView::ClassName(int classIdx) const
{
    return wrIndividualActivityModel_ClassName(m_impl, classIdx);
}
