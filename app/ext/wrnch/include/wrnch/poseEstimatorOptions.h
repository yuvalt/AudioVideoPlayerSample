...
extern "C"
{
    ...
    WRNCH_DLL_INTERFACE wrPoseEstimatorOptionsHandle wrPoseEstimatorOptions_Create(void);
    ...
    WRNCH_DLL_INTERFACE void wrPoseEstimatorOptions_SetUseIK(wrPoseEstimatorOptionsHandle,
                                                             int yesNo);
    ...
    WRNCH_DLL_INTERFACE void wrPoseEstimatorOptions_SetEnableJointSmoothing(
        wrPoseEstimatorOptionsHandle, int yesNo);
    WRNCH_DLL_INTERFACE void wrPoseEstimatorOptions_SetEnableHeadSmoothing(
        wrPoseEstimatorOptionsHandle, int yesNo);
    WRNCH_DLL_INTERFACE void wrPoseEstimatorOptions_SetEstimateHead(wrPoseEstimatorOptionsHandle,
                                                                    int yesNo);
    WRNCH_DLL_INTERFACE void wrPoseEstimatorOptions_SetEstimatePoseFace(
        wrPoseEstimatorOptionsHandle, int yesNo);
    ...
    WRNCH_DLL_INTERFACE int wrPoseEstimatorOptions_GetEstimateMask(
    ...
    WRNCH_DLL_INTERFACE int wrPoseEstimatorOptions_GetEstimateHands(
        wrPoseEstimatorOptionsHandleConst);
    ...
    WRNCH_DLL_INTERFACE int wrPoseEstimatorOptions_GetEnableHeadSmoothing(
        wrPoseEstimatorOptionsHandleConst);
    WRNCH_DLL_INTERFACE int wrPoseEstimatorOptions_GetEstimateHead(
        wrPoseEstimatorOptionsHandleConst);
    WRNCH_DLL_INTERFACE int wrPoseEstimatorOptions_GetEstimatePoseFace(
        wrPoseEstimatorOptionsHandleConst);
    WRNCH_DLL_INTERFACE int wrPoseEstimatorOptions_GetEstimateSingle(
        wrPoseEstimatorOptionsHandleConst);
