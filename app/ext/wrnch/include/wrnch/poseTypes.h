...
extern "C"
{
    ...
    struct wrSerializedData;
    typedef struct wrSerializedData* wrSerializedDataHandle;
    typedef const struct wrSerializedData* wrSerializedDataHandleConst;

    /// @brief Return the number of bytes stored in a serialized estimator.
    WRNCH_DLL_INTERFACE int wrSerializedData_NumBytes(wrSerializedDataHandleConst);
    /// @brief Return a pointer to the bytes stored in a serialized estimator.
    WRNCH_DLL_INTERFACE char const* wrSerializedData_Data(wrSerializedDataHandleConst);
    WRNCH_DLL_INTERFACE void wrSerializedData_Destroy(wrSerializedDataHandle);
    ...
    WRNCH_DLL_INTERFACE wrHandBoxPairHandle wrHandBoxPair_Create(void);
    ...
    WRNCH_DLL_INTERFACE void wrHandBoxPair_Copy(wrHandBoxPairHandleConst src,
                                                wrHandBoxPairHandle dest);
    ...
    WRNCH_DLL_INTERFACE int wrHandBoxPair_Equals(wrHandBoxPairHandleConst,
                                                 wrHandBoxPairHandleConst);

    struct wrPose2d;
    typedef struct wrPose2d* wrPose2dHandle;
    typedef const struct wrPose2d* wrPose2dHandleConst;

    WRNCH_DLL_INTERFACE wrPose2dHandle wrPose2d_Create(int numJoints);
    ...
    */
    ...
    WRNCH_DLL_INTERFACE wrPose3dHandle wrPose3d_Create(int numJoints);
    ...
    WRNCH_DLL_INTERFACE unsigned int wrPose3d_GetScaleHintLength(void);
    ...
    WRNCH_DLL_INTERFACE wrPoseFaceHandle wrPoseFace_Create(void);
    ...
    WRNCH_DLL_INTERFACE wrPoseHeadHandle wrPoseHead_Create(void);
    ...
    WRNCH_DLL_INTERFACE const float* wrPoseHead_GetHeadRotationEuler(wrPoseHeadHandleConst);
    WRNCH_DLL_INTERFACE const float* wrPoseHead_GetHeadRotationQuat(wrPoseHeadHandleConst);
