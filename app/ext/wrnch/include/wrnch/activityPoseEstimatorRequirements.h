...
extern "C"
{
    ...
    typedef struct wrPoseEstimatorRequirements* wrPoseEstimatorRequirementsHandle;
    typedef struct wrPoseEstimatorRequirements const* wrPoseEstimatorRequirementsHandleConst;

    WRNCH_DLL_INTERFACE void wrPoseEstimatorRequirements_Destroy(wrPoseEstimatorRequirementsHandle);
    ...
    ///         requirements. If the returned value is not `wrReturnCode_OK`, no `wrPoseEstimator`
    ///         is created, and nothing is written to `outPoseEstimatorHandle`.
